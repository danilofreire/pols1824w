...
subtitle: "The rational terrorist<html><div style='float:left'></div><hr color='#EB811B' size=1px width=800px></html>"
...
* This setting of incomplete information leads to miscalculations and under- or overestimation of the parties' capabilities  
]
...
* How do terrorists use violence?
]
...
.font140[
* Persuade the enemy that the group is strong
...
* The more unlikely the target state is to make concessions, the more terrorists will resort to attrition
...
.font150[
* Similar to deterrence: preventing undesired behaviour with threats of, and actual, violence

* Left-wing groups, KKK, state terrorism

* Weak states facilitate intimidation strategies

* Citizens are forced to seek protection from local armed groups in the state doesn't provide internal security 
]
...
* To shift citizen support away from the incumbent regime
...
* Often used when two enemies are close to reaching an agreement
  - Algerian civil war, Israel and PLO 
...
.font150[
* "[...] two or more domestic parties are competing for leadership of their side, and the general population is uncertain about which of the groups best represents their interests"
  - Hamas versus Fatah
...
* The most successful group was the Hamas
]
...
* increased involvement in a terrorist movement is a slow marginalisation away from conventional society
