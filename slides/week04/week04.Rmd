...
.font150[
* **Ideology**:
	- Religious/ethnic/racial fanaticism
	- Barbarism
	- However...
]
--
.font150[
* Rebels need popular support / individuals want to stay alive

* Repression is an effective tool to prevent civilian defection
...
* "Invisible borders" between the two areas

* Citizens are often stuck in these areas and are forced to collaborate if rebels establish a monopoly of force
