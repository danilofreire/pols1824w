...
* Strongly politicised term: confers/removes legitimacy
	- Our side: heroes, warriors, freedom fighters
...
.font150[
* **Violence**:
	- Takes many, many forms: physical, verbal, sexual, lethal, etc
...
* What is violence used for?
	...
	- Kalyvas sees "expressive violence" as a problematic category. Why?
]
...
* Strategic/instrumental violence: 
	- Even extremely barbaric uses of violence might have an instrumental purpose
